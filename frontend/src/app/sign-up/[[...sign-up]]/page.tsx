    ...
    <div className="min-h-screen w-screen bg-dark-bg text-foreground flex flex-col lg:flex-row overflow-hidden relative">
      ...
      <div className="hidden lg:flex lg:w-1/2 h-screen relative bg-dark-surface border-r border-white/5 items-center justify-center p-12 overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full z-0 opacity-80 pointer-events-none">
          <AthleteScene scrollProgress={0.3} activeMetric="chest" />
        </div>
        ...
        >
          <div className="flex justify-between items-center mb-2">
            <span className="text-[8px] font-mono text-cyber-blue tracking-widest uppercase">// METABOLIC LOAD LEVEL</span>
            <Dumbbell className="w-3.5 h-3.5 text-cyber-blue animate-pulse" />
          </div>
          <span className="text-sm font-display font-black text-white block">Hypertrophy Overload</span>
          <span className="text-[10px] text-gray-400 font-mono block mt-1.5">4 Sets // Bench Press (80kg)</span>
          <span className="text-[10px] text-neon-green font-mono block mt-0.5">✓ Session Synced</span>
        </motion.div>
        ...
        >
          <div className="flex justify-between items-center mb-2">
            <span className="text-[8px] font-mono text-neon-green tracking-widest uppercase">// NUTRITION RATIOS</span>
            <Utensils className="w-3.5 h-3.5 text-neon-green" />
          </div>
          <span className="text-sm font-display font-black text-white block">2,540 kcal / Daily Target</span>
        ...
        >
          <div className="flex gap-3 items-start">
            ...
            <div>
              <span className="text-[8px] font-mono text-neon-green tracking-widest block uppercase">NEURAL COGNITION SYSTEM</span>
              <p className="text-[10px] text-gray-300 font-light leading-relaxed mt-1">
                Skeletal scan aligned. Metabolic output optimized. Projected lean tissue gain: +4.2kg in 90 days.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <div className="absolute bottom-16 left-16 z-25 max-w-md flex flex-col gap-3">
          ...
          <p className="text-xs text-gray-400 font-light leading-relaxed">
            Enter the future of high-performance physique engineering. Transmit biometrics, map your digital physical twin, and let AI program your Metamorphosis.
          </p>
        </div>
      </div>
          ...
          <div className="w-full glass-panel p-8 sm:p-10 rounded-2xl border border-white/10 shadow-2xl relative">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-[10px] font-mono text-gray-500 mt-1 uppercase tracking-wide">
                Initialize biometrics calibration sequence
              </p>
            </div>
            ...
            <div className="mt-6 border-t border-white/5 pt-6 text-center">
              <span className="text-gray-400 font-mono text-[10px]">
                ...
                <Link href="/sign-in" className="text-neon-green hover:underline hover:text-white transition-colors duration-200 ml-1">
                  Log In
                </Link>
              </span>
            </div>
